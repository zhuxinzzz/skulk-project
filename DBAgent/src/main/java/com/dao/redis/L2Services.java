...
//    @Bean
    ...
    public void writeUserOfflineMessageRecord(String theKeyOfTheUserSOfflineInformationRecord,
                                              String lineNumberAndFilenameValues){
        l9ToRedis.set(PREFIX_USER_OFFLINE_MESSAGE_RECORD+ SEPARATOR + theKeyOfTheUserSOfflineInformationRecord,
                lineNumberAndFilenameValues);
