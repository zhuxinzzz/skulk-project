...
@SpringBootTest(classes = ApplicationDBAgent.class)
//@Transactional
...
//        redisTemplate.opsForValue().set(userOffline1, o);
    ...
    @Test
    public void l1ObtainUserOfflineMessageRecords(){
        String userOfflineMessage = l1Api.getUserOfflineMessage("user1");
    ...
    @Test
    public void testL2SAbilityToWriteUserOfflineMessages() {
        l2Services.writeUserOfflineMessageRecord(
                "user1",
                "行号-文件名");
    }
}
